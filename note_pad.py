...
app=Flask(__name__)
app.secret_key="mysecret"       #This line of code must be written for messages to show while using flash

app.config['SQLALCHEMY_DATABASE_URI'] = (
    "mssql+pyodbc://@OLADIMEJI\\SQLEXPRESS/db_notes?driver=ODBC+Driver+17+for+SQL+Server&trusted_connection=yes"
)
...
news_api_key = "4e5813c35eb04e2e80d0f30c0427bad8"
